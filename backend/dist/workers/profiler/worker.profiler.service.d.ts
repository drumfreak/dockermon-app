...
export declare class WorkerProfilerService {
    ...
    constructor(http: HttpService, socketClientService: WorkersSocketIoClientProxyService, containersService: ContainersService, profilerService: ProfilingService, dockerHostService: DockerHostsService, statsUtility: StatsUtility, statsService: StatsService);
