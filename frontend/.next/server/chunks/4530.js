...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DockerImageTags)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var primereact_treetable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1249);
...
/* harmony import */ var primereact_paginator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6895);
...
/* harmony import */ var _services_socket_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1515);
...
/* harmony import */ var primereact_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(4355);
/* harmony import */ var primereact_utils__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(primereact_utils__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(6022);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var primereact_confirmpopup__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(715);
/* harmony import */ var primereact_confirmpopup__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(primereact_confirmpopup__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var primereact_inputtextarea__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(6085);
/* harmony import */ var primereact_inputtextarea__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(primereact_inputtextarea__WEBPACK_IMPORTED_MODULE_17__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_services_socket_service__WEBPACK_IMPORTED_MODULE_10__]);
_services_socket_service__WEBPACK_IMPORTED_MODULE_10__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function DockerImageTags(props) {
    ...
    const localImagesObject = (0,react_redux__WEBPACK_IMPORTED_MODULE_15__.useSelector)((state)=>{
        return state.images;
    });
    ...
    const { 0: progressLog , 1: setProgressLog  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
    const progressLogRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(progressLog);
    progressLogRef.current = progressLog;
    const { 0: msgs1 , 1: setMsgs1  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
    const { 0: expandedKeys , 1: setExpandedKeys  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({});
    const { 0: results1 , 1: setResults  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
    const { 0: image1 , 1: setImage  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
    const imageRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(image1);
    imageRef.current = image1;
    const { 0: tags1 , 1: setTags  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
    const tagsRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(tags1);
    tagsRef.current = tags1;
    const { 0: imageId , 1: setImageId  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
    ...
    async function loadSocket() {
        ...
        const socket = await _services_socket_service__WEBPACK_IMPORTED_MODULE_10__/* .socketService.getSocket */ .L.getSocket();
    ...
    const LogContainer = ()=>{
        ...
        return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(primereact_inputtextarea__WEBPACK_IMPORTED_MODULE_17__.InputTextarea, {
                    ref: messagesEndRef,
                    autoCorrect: "off",
                    spellCheck: "false",
                    autoComplete: "false",
    ...
    const lastUpdatedTemplate = (rowData)=>{
        if (rowData.data.last_updated) {
            return(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                children: dayjs__WEBPACK_IMPORTED_MODULE_5__(rowData.data.last_updated).format('YYYY-MM-DD HH:mm:ss')
            }));
        } else {
    ...
    const confirm = (action, imageName, title, target = null)=>{
        (0,primereact_confirmpopup__WEBPACK_IMPORTED_MODULE_16__.confirmPopup)({
            message: title,
    ...
    const template1 = {
        ...
        PageLinks: (options)=>{
            if (options.view.startPage === options.page && options.view.startPage !== 0 || options.view.endPage === options.page && options.page + 1 !== options.totalPages) {
                const className = (0,primereact_utils__WEBPACK_IMPORTED_MODULE_14__.classNames)(options.className, {
                    'p-disabled': true
                });
    ...
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(primereact_toast__WEBPACK_IMPORTED_MODULE_9__.Toast, {
                ref: toast
            }),
                ...
                children: !hideTags && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    children: (results1 === null || results1 === void 0 ? void 0 : results1.length) > 0 && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(primereact_treetable__WEBPACK_IMPORTED_MODULE_6__.TreeTable, {
                                value: results1,
                                stripedRows: true,
                                rowHover: true,
                                showGridlines: true,
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(primereact_paginator__WEBPACK_IMPORTED_MODULE_8__.Paginator, {
                                template: template1,
                                first: tableFirst,
                                rows: tableRows,
