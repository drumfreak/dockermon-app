...
function ActivityLogIndex(props) {
    ...
    const { 0: contentType , 1: setContentType  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)();
    const contentTypeRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(contentType);
    contentTypeRef.current = contentType;
    const { 0: contentId , 1: setContentId  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)();
