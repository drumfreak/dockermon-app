...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CreateNetworkView)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
...
function CreateNetworkView() {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
        ...
        return ()=>{
            if (socketRef.current) {
                socketRef.current.removeListener('createNetworkForm');
            }
        };
    }, []);
    const clearMessages = ()=>{
    ...
    async function loadSocket() {
        ...
        socket.on('createNetworkForm', (results)=>{
            // console.debug('-----------> Create Network Result  ', results);
            if (results.status === 'success') {
                (0,primereact_confirmdialog__WEBPACK_IMPORTED_MODULE_3__.confirmDialog)({
                    ...
                    accept: ()=>router.push('/networks/' + results.data.id)
                    ,
...
var __webpack_exports__ = __webpack_require__.X(0, [1515,9861], () => (__webpack_exec__(910)));
